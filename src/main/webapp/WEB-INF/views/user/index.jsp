			...
			<div class="well np">
				<div id="myCarousel" class="carousel slide homCar">
					<div class="carousel-inner">
						...
						<c:forEach var="item" items="${tb_slide }" varStatus="index">
								...
								<li class="span3">
									<div class="thumbnail">
										<a class="zoomTool" href="product_details.html"
											...
											src="<c:url value="/assets/user/img/products/${ item.image }"/>" alt=""></a>
									</div>
								</li>
			...
			<div class="row-fluid">
				<c:if test="${ products.size() > 0 }">
					<ul class="thumbnails">
						...
						<c:forEach var="item" items="${ highLightsProducts }" varStatus="loop">
							<li class="span4">
								<div class="thumbnail">
									<a class="zoomTool" href="<c:url value ="/chi-tiet-san-pham/${ item.id_product }"/>"  title="add to cart"><span
										...
										href="chi-tiet-san-pham/${ item.id_product }"><img style="min-height: 260px"
										src="<c:url value="/assets/user/img/products/${ item.image }"/>" alt=""></a>
									<div class="caption">
										<h5>${ item.name }</h5>
										<h4>
