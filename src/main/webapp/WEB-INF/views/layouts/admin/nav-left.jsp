...
<!-- Main Sidebar Container -->
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index3.html" class="brand-link"> <img
				src="<c:url value="/assets/admin/dist/img/AdminLTELogo.png"/>"
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					<div class="image">
						<img
							src="<c:url value="/assets/admin/dist/img/user2-160x160.jpg"/>"
							class="img-circle elevation-2" alt="User Image">
					</div>
					<div class="info">
						<a href="#" class="d-block"><c:if test="${ not empty LoginInfo }">${ LoginInfo.display_name } </c:if></a>
					</div>
				</div>
               ...
               with font-awesome or any other icon font library -->
						<li class="nav-item menu-open"><a href="#"
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item"><a href="<c:url value ="/quan-tri/danh-sach-san-pham"/>"
